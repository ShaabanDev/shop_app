...
class ProductsProvider with ChangeNotifier {
  ...
  Future<void> fetchAndSettProducts([bool filterProducts = false]) async {
    final filterString = filterProducts ? "" : "";
    var url = Uri.parse(
        'https://shop-7b8f0-default-rtdb.firebaseio.com/products.json?auth=$token&orderBy="creatorId"&equalTo="$userId"');
    try {
