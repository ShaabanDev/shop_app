...
class ProductsProvider with ChangeNotifier {
  ...
  Future<void> deleteProductItem(String productId) async {
    var url = Uri.parse(
        "https://shop-7b8f0-default-rtdb.firebaseio.com/products/$productId.json");

    final porductIndex =
        _items.indexWhere((element) => element.id == productId);
    final existingProduct = _items[porductIndex];
  ...
  Future<void> fetchAndSettProducts() async {
    var url = Uri.parse(
        "https://shop-7b8f0-default-rtdb.firebaseio.com/products.json");
    try {
